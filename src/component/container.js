(function() {
	 ...
	 **/
	DI.App.LemonaideContainer = React.createClass({displayName: "LemonaideContainer",
		/**
			...
			return (
				React.createElement("div", {className: "grid", id: "content"}, 
					...
					React.createElement("section", null, 
						React.createElement(DI.App.LemonaideFormControl, {
							onExpandControl: this.handleFormExpand, 
							onCollapseControl: this.handleFormCollapse}), 
						React.createElement(DI.App.LemonaideForm, {
							onReportSubmit: this.handleReportSubmit, 
							isFormCollapsed: this.state.isFormCollapsed}), 
						React.createElement(DI.App.LemonaideReportList, {
	 ...
	 **/
	React.render(
		React.createElement(DI.App.LemonaideContainer, {url: "/data/sales"}),
